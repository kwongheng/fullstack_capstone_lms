...
@Entity
@Table(name = "BORROW", indexes = @Index(name = "IDX_BORROW_DATES", columnList = "borrow_date, due_date"))
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class Borrow {
	...
	@Column(name = "is_returned", columnDefinition = "BOOLEAN NULL DEFAULT FALSE")
	@Builder.Default
	private Boolean isReturned = false;

//	public boolean isReturned() {
//	    return Boolean.TRUE.equals(isReturned);  // null or true = returned, false = active
//	}

	public void setReturned(boolean returned) {
	    this.isReturned = returned ? null : false;
	}
