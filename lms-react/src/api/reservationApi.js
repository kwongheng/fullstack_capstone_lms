...
export const reservationApi = {
  ...
  reserveBook: (memberUserId, bookId) =>
    axiosInstance.post("/reservations", { memberUserId, bookId }),

  // Admin fulfills a reservation (when issuing book)
  fulfillReservation: (reservationId) =>
    axiosInstance.patch(`/reservations/${reservationId}/fulfill`),

  // User or Admin cancels a reservation
  cancelReservation: (reservationId) =>
    axiosInstance.delete(`/reservations/${reservationId}`),
}